...
:   Facilitators (“mmm-hmmm”, “yeah”, “ok”, “oh”) and Paraphrases (C: “I was six” I: “you were six.”) (see @nte-me).
...
:   Context: prompts requesting background/descriptive information that is not specific to an episode of abuse or about the generic abuse script or initial disclosure event (see @nte-context)
...
:   Clarification-seeking: Prompts seeking to verify/clarify information (see @nte-clarification)
...
Code questions that match category **4, 5, or 6** from the `Griffiths/Waterhouse Question Map`. If more than one category applies, use the higher numbered category.
...
: Question Type Categories (adapted from Griffiths/Waterhouse Question Map) {#tbl-griffiths .info .hover .sm}

::: {#tip-suggestive .callout-tip title="Suggestive Question Tips"}
Common suggestive questions include closed-ended questions that clearly suggest the expected or desired response.

•Negative term questions: Questions that ask children to confirm a negative assertion; e.g., ‘He didn’t have anything in his hand?’

•Tag questions: Questions that involve complete sentences with an interrogative tag at the end; e.g. ‘No one else was there, right?’

•Declarative questions: Direct questions that take the form of complete statements; e.g. ‘But you remember your couch moving?’
:::
...
## B1/B2/B3 (just B for `e>disclosure` or `non-abusive event`)
...
-   **same**: same question type category (same number, see @tbl-griffiths)

...
[**SPECIAL (not child response) Interviewer reactions to off-track responses will be coded.**]{.underline} The code should be applied to the interviewer's subsequent prompt and account for all the interviewer's reactions following the off-track response until the prompt.

...
|               |                 |               |               |               |
| -   cue       | -   conditional | -   3         | -   refusal   | -   reject-l  |
|               |                 |               |               |               |
| -   single    | -   you         |               | -   idk       |               |
|               |                 |               |               |               |
| -   ambiguous |                 |               | -   sidetrack |               |
...
**Reject-L**: This is an extension of the code above. It is used when the interviewer's reaction also includes a leading question (see @nte-lq) that introduces information the child has not mentioned previously or that implies a desired response. The question may also include other suggestive techniques, such as mentioning what the interviewer has heard from other sources.

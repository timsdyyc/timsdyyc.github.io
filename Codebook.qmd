...
-   **Optional**
    ...
    -   Optional qualifier: indicate that an act may or may not occur in a given instance.
    -   Markers: *sometimes*, *usually*, *maybe*, *might*
    -   Example: “We usually have the first snack on the roof.”

-   **Alternative**

    -   Alternative acts: Present competing options for the same event slot.
    -   Markers: *or*
    -   Example: “Then we go on the bus or our mommy picks us up.”

-   **Conditional**

    -   Conditional acts: Require specific preconditions for an act to occur, often expressed through enabling or temporal conditions.
    -   Markers: *if*, *when*, *because*, *whenever*
    -   Example: “Whenever we go to Grandma’s, we have cookies.”

-   **Tense**

    -   Timeless Present Tense: Describes general routines or procedures using present tense verbs.
    -   Example: “We order food at a restaurant.”

-   **You**

    -   Impersonal "You" pronoun: Generalises the experience to any person, not the speaker or listener specifically. Usually only applies to statements in timeless present tense.
    -   Example: “You go in, you sit down, you order.”

-   **Habitual**

    -   Habitual past constructions: Describe repeated actions in the past using specific grammatical forms.
    -   Markers: *used to*, *would* (habitual use)
    -   Example: “He used to order food at a restaurant.”

-   **Always**

    -   Other strong habitual markers: Emphasise consistent repetition across all instances.
...
-   **Cue**: A response that contains linguistic cues that the child is recalling generic script information when the interviewer is asking about a particular episode of abuse. This only applies when the interviewer and child have explicitly established that there was repeated abuse.

    -   Include the cue type (e.g., `ot>cue>tense`; see @sec-cue)

### React {#sec-react}

[**SPECIAL (not child response) Interviewer reactions to off-track responses will be coded.**]{.underline} The code (adapted from [Earhart et al. 2019](https://onlinelibrary.wiley.com/doi/10.1002/bsl.2141)) should be applied to the interviewer's subsequent prompt and account for all the interviewer's reactions following the off-track response until the prompt.
...
7.  If the interviewer repeats a prompt when the child does not respond, or in order to clarify, only code the final prompt.
